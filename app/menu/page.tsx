...
import { Plus, ShoppingBag, X, UtensilsCrossed } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-32 pt-10">
            <header className="bg-white px-6 py-10 text-center border-b mb-6">
                <h1 className="text-3xl font-black tracking-tight text-gray-900 uppercase">Kana Dining</h1>
                <p className="text-gray-400 text-xs mt-1 font-bold tracking-widest">AUTHENTIC ETHIOPIAN CUISINE</p>
            </header>
                        ...
                        <div className="p-5">
                            ...
                            <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-50">
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-xl font-black text-blue-600">{item.price} <span className="text-xs">ETB</span></span>
                                </div>
